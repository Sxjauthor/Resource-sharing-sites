...
<div class="container-fluid" id="con2">
    <div class="row" id="searchInfo">
        <div id="aa" class="mt-3">
            <a class="d-block me-3 ${requestScope.type=="2"?'border-bottom border-secondary border-2':''}" href="${pageContext.request.contextPath}/resDetail?act=myFav">软件</a>
            <a class="d-block me-3 ${requestScope.type=="3"?'border-bottom border-secondary border-2':''}" href="${pageContext.request.contextPath}/resDetail?act=myFav&type=3">资料</a>
            <a class="d-block ${requestScope.type=="1"?'border-bottom border-secondary border-2':''}" href="${pageContext.request.contextPath}/resDetail?act=myFav&type=1">壁纸</a>
        </div>
    </div>
