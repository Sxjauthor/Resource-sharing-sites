...
<div class="container-fluid">
    ...
    <div class="card container-fluid mb-4" id="card">
        <form id="sendForm" class="row g-3 card-body" method="post" action="${pageContext.request.contextPath}/notice?act=add">
            <input type="hidden" name="creater" value="${sessionScope.manager.id}">
            <div class="col-6">
