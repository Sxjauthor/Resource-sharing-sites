        ...
        <div class="col-md-4">
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <a href="${pageContext.request.contextPath}/resDetail?act=downloadS&id=${requestScope.res.id}" class="btn btn-success btn-block" id="get" name="${requestScope.res.isFree}">下载软件</a>
    ...
    $("#fav").click(function (){
        ...
        if(s==1){
            $.ajax({
                ...
                type:'post',
                data:'act=fav2&i=1&id='+"${requestScope.res.id}",
                dataType:'json',
